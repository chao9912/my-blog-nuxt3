...
<template>
  <div>
    <section class="banner-cu relative overflow-hidden bg-gradient-to-br from-[#E8F9FA] via-[#E5F7FA] to-[#F0FCFD] px-6 pb-8 pt-[84px] lg:px-10 lg:pb-12 lg:pt-[84px]">
      ...
      <div class="relative z-10 flex items-center gap-6">
        <div class="relative">
          ...
          <div class="relative w-20 h-20 rounded-full bg-gradient-to-br from-[#22C7D6] to-[#287FFD] flex items-center justify-center shadow-xl">
        ...
        <div class="flex items-center gap-2">
          ...
          <template v-if="totalPages <= 5">
            <button
              ...
              :class="page === pageNum
                ? 'bg-gradient-to-r from-[#22C7D6] to-[#287FFD] text-white shadow-lg shadow-[#22C7D6]/30'
